...
def main() -> None:
    ...
    # workflow paths
    create_endpoint_microplate_wf = wf_directory / "create_endpoint_microplate_wf.yaml"
    create_T0_micriplate_wf = wf_directory / "create_T0_microplate_wf.yaml"
    inoculate_new_deepwell_wf = wf_directory / "inoculate_new_deepwell_wf.yaml"
    new_deepwell_to_inc_wf = wf_directory / "new_deepwell_to_inc_wf.yaml"
    read_endpoint_microplate_wf = wf_directory / "read_endpoint_microplate_wf.yaml"
    read_current_deepwell_to_opentrons_wf = wf_directory / "read_current_deepwell_to_opentrons_wf.yaml"
    trash_old_deepwell_wf = wf_directory / "trash_old_deepwell_wf.yaml"

    # protocol paths (for OT-2)
    create_microplate_protocol = protocol_directory / "create_microplate.py"
    inoculate_deepwell_protocol = protocol_directory / "inoculate_deepwell.py"

    # experiment 1: incubation = 1 hr cycles, transfers every 10 hours
    exp1_variables = {
        "incubation_seconds": 36000,  # 10 hours = 36,000 seconds
        "lid_location": "lidnest1",
        "ot2_node": "ot2biobeta",
        "ot2_T0_microplate_location": "ot2biobeta_deck1_wide", 
        "ot2_endpoint_microplate_location": "ot2biobeta_deck3_wide",
        "old_deepwell_location": "ot2biobeta_deck1_wide",
        "new_deepwell_location": "ot2biobeta_deck3_wide",
    ...
    payload = {
        ...
        "ot2_location": exp1_variables["ot2_new_plate_location"],  # where to start?
