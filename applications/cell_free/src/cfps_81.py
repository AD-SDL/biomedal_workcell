...
def main() -> None:
    ...
    run_cfps = protocol_directory / "pd_cfps_81.py"
    run_cfps2 = protocol_directory / "pd_cfps_81_2.py"
    ...
    #move cell free plate to staging, seal, return
    ...
    #move to heater shaker and incubate
    payload = {"current_flex_protocol": str(run_cfps2)}
    experiment_client.start_run(
        run_flex_wf.resolve(),
        payload=payload,
        blocking=True,
