...
def main() -> None:
    ...
    run_fdglu = protocol_directory / "pd_fdglu_assay_81.py"
    ...
    move_D2_to_A4_protocol = protocol_directory / "move_to_staging_D2_A4.py"
    move_A4_to_C2_protocol = protocol_directory / "move_from_staging_A4_C2.py"
    ...
    #move cfps plate from staging to peeler and back
    ...
    #move cfps to C2
    payload = {"current_flex_protocol": str(move_A4_to_C2_protocol)}
    experiment_client.start_run(
        run_flex_wf.resolve(),
        payload=payload,
        blocking=True,
    ...
    #move fdglu to hidex
    payload = {"current_flex_protocol": str(move_D2_to_A4_protocol)}
    experiment_client.start_run(
        run_flex_wf.resolve(),
        payload=payload,
        blocking=True,
