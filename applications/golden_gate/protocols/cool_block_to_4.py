...
metadata = {
    'protocolName': 'cool temp block to 4 deg',
    'author': 'Abe Stroka',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    temp_mod.set_temperature(4) #TODO: make seperate, or just set earlier, only 1 hour with plate
    temp_mod2.set_temperature(4)
