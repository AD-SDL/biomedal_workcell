...
def run(protocol: protocol_api.ProtocolContext):
    ...
    mastermix_tube = protocol.load_labware('nest_96_wellplate_100ul_pcr_full_skirt', 'B3') 
    ...
    protocol.move_labware(labware=mastermix_tube, new_location="A4", use_gripper=True)