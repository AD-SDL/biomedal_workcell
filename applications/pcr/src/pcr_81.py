...
def main() -> None:
    ...
    move_from_staging_B1_protocol = protocol_directory / "move_from_staging_A4_B1.py"
    move_to_staging_C2_protocol = protocol_directory / "move_to_staging_C2_A4.py"
    ...
    #peel gg product, place in flex C1
    ...
    #peel source plate, place back on B1
